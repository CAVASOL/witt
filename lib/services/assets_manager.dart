class AssetsManager {
  ...
  static String appleLogo = "$imagePath/apple.png";
  static String busPicture = "$imagePath/bus.jpg";
  static String chatGPT = "$imagePath/chatgpt_logo.png";
  static String cityStreet = "$imagePath/city_street.jpg";
  static String filterImg = "$imagePath/filter.png";
